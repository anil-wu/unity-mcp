...
> 面向 Unity 2022.2 / 2022.3（本仓库测试工程使用 2022.2.21f1；插件代码两者通用）。Unity 6.2+ 官方已内置 MCP，本仓库针对**无内置 MCP 的 2022 系列**做「移植」：把 MCP 协议层直接做进编辑器，去掉 Python 中间层。
...
1. 用 Unity Hub 打开本仓库目录（Unity 2022.2.21f1 或 2022.3）。
